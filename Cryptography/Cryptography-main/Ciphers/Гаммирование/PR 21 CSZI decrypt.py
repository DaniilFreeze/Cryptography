...
b = 5
M = pow(2, b)
text = input("Введите текст, который необходимо расшифровать: ")
...
print("Специально для Вас и Вашего удобства представлен список номеров букв русского алфавита:\n ", by)

bit_word = [format(x, 'b') for x in by]
print("Бинарный список номеров букв русского алфавита:\n", bit_word)

print("Вы можете наблюдать на данном этапе процесс генерации псевдослучайных чисел: ")
...
print("Итоговый дешифрованный текст в числовом виде:\n ", summa_shifr)
c = []
